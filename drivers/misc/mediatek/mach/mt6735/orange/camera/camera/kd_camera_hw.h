...
#define CAMERA_CMPDN_PIN            GPIO_CAMERA_INVALID //GPIO_CAMERA_CMPDN_PIN
#define CAMERA_CMPDN_PIN_M_GPIO     GPIO_CAMERA_INVALID //GPIO_CAMERA_CMPDN_PIN_M_GPIO

//FRONT sensor
#define CAMERA_CMRST1_PIN           GPIO_CAMERA_INVALID //GPIO_CAMERA_CMRST1_PIN
#define CAMERA_CMRST1_PIN_M_GPIO    GPIO_CAMERA_INVALID //GPIO_CAMERA_CMRST1_PIN_M_GPIO
