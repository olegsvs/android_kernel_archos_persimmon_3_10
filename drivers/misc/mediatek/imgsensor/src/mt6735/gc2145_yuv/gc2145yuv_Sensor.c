...
static void GC2145_Sensor_Init(void)
{
	...
	GC2145_write_cmos_sensor(0x95, 0x45);  ///b6
	GC2145_write_cmos_sensor(0x97, 0x45);//64
	...
	GC2145_write_cmos_sensor(0x82, 0x0f);//08
	GC2145_write_cmos_sensor(0x83, 0x08);//05
	...
	*/
	...
	GC2145_write_cmos_sensor(0xd3, 0x42);  //44
