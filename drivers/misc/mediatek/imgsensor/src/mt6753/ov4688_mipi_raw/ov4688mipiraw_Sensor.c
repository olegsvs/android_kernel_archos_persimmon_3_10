...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        .pclk = 120000000, //112000000,//224000000,                //record different mode's pclk
        .linelength = 0x67c,                //record different mode's linelength
        .framelength = 0x700,            //record different mode's framelength
        .startx = 0,                    //record different mode's startx of grabwindow
        .starty = 0,                    //record different mode's starty of grabwindow
        .grabwindow_width = 0xa80,        //0xA80//record different mode's width of grabwindow
        .grabwindow_height = 0x5f0,       //0X5F0 //record different mode's height of grabwindow
    ...
    .cap = {
        .pclk = 120000000, //112000000,//224000000,
        .linelength = 0x67c,                //record different mode's linelength
        .framelength = 0x700,            //record different mode's framelength
        .startx = 0,
        .starty = 0,
    ...
    .normal_video = {
        .pclk = 120000000, // 112000000,//224000000,                //record different mode's pclk
        .linelength = 2232,                //record different mode's linelength
    ...
    .mipi_lane_num = SENSOR_MIPI_4_LANE,//HTC//mipi lane num
...
{
	 { 2703, 1527,      8,              4,            2688, 1520,   2688, 1520,   0, 0,    2688, 1520,      0,    0, 2688, 1520}, // Preview
	 { 2703, 1527,      8,              4,            2688, 1520,   2688, 1520,   0, 0,    2688, 1520,      0,    0, 2688, 1520}, // capture
	 { 2703, 1527,      8,              4,            2688, 1520,   2688, 1520,   0, 0,    2688, 1520,      0,    0, 2688, 1520}, // video
	 { 2703, 1527,      8,              4,            2688, 1520,   2688, 1520,   0, 0,    2688, 1520,      0,    0, 2688, 1520} , //hight speed video
	 { 2703, 1527,      8,              4,            2688, 1520,   2688, 1520,   0, 0,    2688, 1520,      0,    0, 2688, 1520} // slim video
};
...
write_cmos_sensor(0x0100,0x01);   //Sensor go to standby
mDELAY(10);
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	write_cmos_sensor(0x380d, 0xb8);      // HTS L
	...
	write_cmos_sensor(0x3820, 0x06);      // flip off, bin off
	write_cmos_sensor(0x3821, 0x00);      // mirror off, bin off
