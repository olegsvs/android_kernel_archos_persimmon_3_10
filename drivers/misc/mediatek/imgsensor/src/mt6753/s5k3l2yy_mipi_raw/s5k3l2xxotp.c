...
static unsigned short force[] = {CAM_CAL_I2C_GROUP_ID, S5K3L2_OTP_DEVICE_ID, I2C_CLIENT_END, I2C_CLIENT_END};   
#else
//static unsigned short force[] = {IMG_SENSOR_I2C_GROUP_ID, S5K3L2_OTP_DEVICE_ID, I2C_CLIENT_END, I2C_CLIENT_END};   
#endif
...
//    spin_lock_init(&g_CAM_CALLock);
    ...
    g_pstI2Cclient->addr = S5K3L2_OTP_DEVICE_ID>>1;
